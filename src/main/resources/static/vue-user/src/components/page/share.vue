    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="noteType" label="笔记">
                        <template slot-scope="scope">
...
import { addDataByCollection } from '../../api/collections';
    ...
    methods: {
        ...
        getData() {
            fetchData(this.query).then(res => {
                this.tableData = res.data.allShare;
                this.MyTableData = res.data.myShare;
                this.pageTotal = res.data.allShare.length;
            });
        },
        // 删除操作
